...
<h2 class="sub-header">添加民族信息</h2><hr>
			<div class="col-sm-9  col-md-10  main">
				<div class="table-responsive">
					<!-- 基本信息 -->
					<sf:form method="post" id="nation_info" modelAttribute="nation"
						action="/BMweb/admin/addNaitonInfoIdex">
...
<!-- 							<tr>
						...
						<button type="submit" class="btn btn-danger center-block"
							style="margin-bottom:30px;" onclick="$('#nation_info').submit();">保存</button>
					</sf:form>
				</div>
			</div>
