	...
	<div class="col-sm-9  col-md-10  main">
		<div class="table-responsive">
					...
					<sf:form method="post" id="bbm" modelAttribute="bbm_info"
						action="/BMweb/admin/updateBbmInfo?update">
						<input name="b_id" type="hidden" value="${bbminfo.b_id}">
						<input name="identity" type="hidden" value="${bbminfo.identity}">
						...
						<button type="submit" class="btn btn-danger center-block"
							style="margin-bottom:30px;" onclick="$(bbm).submit();">保存</button>
					</sf:form>
					</div>
					</div>
