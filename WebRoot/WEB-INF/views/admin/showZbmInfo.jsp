				...
				<div class="table-responsive">
					...
					<table class="table table-bordered">
						...
						<tr>
							...
							<td>${zbm_info.identity}</td>
						</tr>
						<tr>
							<td style="text-align:right;"><font color="#FF0000"
								size="3px;"> * </font>第一志愿</td>
							<td>${zbm_info.shool.s_name}</td>
						</tr>
						
						<tr>
							<td style="text-align:right;"><font color="#FF0000"
								size="3px;"> * </font>专业一</td>
							<td>${zbm_info.pro_1.p_name}</td>
						</tr>
						<tr>
							<td style="text-align:right;"><font color="#FF0000"
								size="3px;"> * </font>专业二</td>
							<td>${zbm_info.pro_2.p_name}</td>
						</tr>
						
 						<tr>
							<td style="text-align:right;"><font color="#FF0000"
								size="3px;"> * </font>第二志愿</td>
							<td>${zbm_info.shool_1.s_name}</td>
						</tr> 
						<tr>
							<td style="text-align:right;"><font color="#FF0000"
								size="3px;"> * </font>专业二</td>
							<td>${zbm_info.pro_3.p_name}</td>
						</tr>
						<tr>
							<td style="text-align:right;"><font color="#FF0000"
								size="3px;"> * </font>专业二</td>
							<td>${zbm_info.pro_4.p_name}</td>
						</tr>
					</table>
						
						<a href="/BMweb/admin/editZbmInfo/${zbminfo.identity}" type="button" class="btn btn-danger center-block"
