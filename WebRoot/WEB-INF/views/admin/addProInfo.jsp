...
<h2 class="sub-header">添加专业信息</h2><hr>
			<div class="col-sm-9  col-md-10  main">
				<div class="table-responsive">
					<!-- 基本信息 -->
					<sf:form method="post" id="pro_info" modelAttribute="pro"
						action="/BMweb/admin/addProlInfoIdex">
						...
						<button type="submit" class="btn btn-danger center-block"
							style="margin-bottom:30px;" onclick="$('#pro_info').submit();">保存</button>
					</sf:form>
				</div>
			</div>
