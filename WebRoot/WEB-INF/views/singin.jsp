...
<html lang="zh-CN">
  ...
  <!-- 顶部 -->
	...
	<form class="form-signin" method="post" role="form" action="process/login" id="login_form">
        ...
        <h3 class="form-signin-heading"><b>登录报名系统</b></h3>
        ...
        <!--  <a style="color:#a94442 " class="hide error_message1">账户不存在</a> -->
        <div class="checkbox">
          <label>
	  ...
	  还不是本系统用户？&nbsp;&nbsp;&nbsp;<a href="/BMweb/user/register" type="button" class="btn btn-default">注册新用户</a>
	  </div>
