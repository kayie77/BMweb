	...
	<div>
		...
		<div style="width: 960px;margin: 0px auto;font-size: 14px;">
			...
			<span style="color:#0572B4">已添加报名信息，点击下面按钮查看相应信息</span></br></br>
					<a href="/BMweb/bminfo/showZuserInfo/${currUser.identity}" type="button" class="btn btn-default media-heading">
					个人基本信息
					</a>
					<a href="/BMweb/bminfo/showZbmInfo/${currUser.identity}" type="button" class="btn btn-default media-heading">
					志愿信息
					</a>
