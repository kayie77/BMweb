		...
		<div style="width: 960px;margin: 0px auto;font-size: 14px;">
			<table class="table table-bordered" style="margin-top:20px;">
				...
				<table>
					...
					<!-- 志愿信息 -->
					<sf:form method="post" id="zbm" modelAttribute="bbm_info">
					<table class="table table-bordered">
						<tr>
							<td style="font-weight:bold;width:340px;"><font color="#0D69D3">志愿信息：</font></td>
							<td><c:if test="${currUser.identity==bbminfo.identity}"><font color="#009933">信息已提交至系统</font></c:if></td>
						</tr>
						<tr>
					...
					<c:if test="${currUser.identity==bbminfo.identity}">
						<a href="/BMweb/bminfo/editBbmInfo/${bbminfo.identity}" type="button" class="btn btn-danger center-block"
