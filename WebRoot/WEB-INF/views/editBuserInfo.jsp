	...
	<div>
		...
		<div class="page-header"
			...
			<h2 style="width:960px;margin:0px auto;">
				<b>广西高校联合招生网 本科生 报名系统 编辑个人基本信息</b>
			</h2>
		</div>
		...
		<div style="width: 960px;margin: 0px auto;font-size: 14px;">
			<table class="table table-bordered" style="margin-top:20px;">
				...
				<table>
					...
					<!-- 基本信息 -->
					<sf:form method="post" id="Busr_info" modelAttribute="u_info"
						action="/BMweb/bminfo/updateBuserInfo?update">
						...
						<button type="submit" class="btn btn-danger center-block"
							style="margin-bottom:30px;" onclick="$('#Busr_info').submit();">保存</button>
					</sf:form>
					</div>
